...
try:
    ...
    db = server.create('fiestasmartes')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['fiestasmartes']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
#twitterStream.filter(locations=[-78.472407,-0.127235,-78.462398,-0.117383])
twitterStream.filter(track=['ecuador','fiestas','quito'])
